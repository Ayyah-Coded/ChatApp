...
import { USER_CREATED_ROUTING_KEY,  USER_EVENTS_EXCHANGE, type UserCreatedEvent,
} from 'common';
import { connect, type Channel, type ChannelModel, type ConsumeMessage, type Replies 
} from 'amqplib';
