...
const parsedConversation = (params) => {
...
export const listConversationHandler = asyncHandler(async (req, res) => {
    const user = getAuthenticatedUser(req);
...
export const listMessageHandler = asyncHandler(async (req, res) => {
    const user = getAuthenticatedUser(req);
    const conversationId = parsedConversation(req.params);
